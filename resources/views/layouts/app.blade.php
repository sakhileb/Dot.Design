...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .sl.active { border-left:4px solid #d946ef;background:rgba(217,70,239,0.1);color:#f0abfc;opacity:1; }
...
<body>
    ...
    <aside style="position:fixed;left:0;top:0;height:100vh;width:272px;background:#131b2e;border-right:1px solid rgba(67,70,86,0.2);z-index:50;overflow-y:auto;padding:1.75rem 1rem;display:flex;flex-direction:column;">
        <div style="margin-bottom:1.75rem;padding:0 0.5rem;">
            <a href="{{ route('dashboard') }}" style="display:flex;align-items:center;gap:0.75rem;text-decoration:none;">
                <div style="width:34px;height:34px;border-radius:8px;background:linear-gradient(135deg,#d946ef,#a21caf);display:flex;align-items:center;justify-content:center;">
                    <span class="material-symbols-outlined" style="font-size:18px;color:#fff;">palette</span>
                </div>
                <div>
                    <div style="font-family:'Manrope',sans-serif;font-size:1rem;font-weight:800;color:#b6c4ff;">Dot.Design</div>
                    <div style="font-size:0.58rem;font-weight:600;color:#8d90a2;letter-spacing:0.15em;text-transform:uppercase;">AI Design Studio</div>
                </div>
            </a>
        </div>
        <div style="margin:0 0.25rem 1.5rem;">
            <a href="#" style="display:flex;align-items:center;justify-content:center;gap:0.5rem;border-radius:9999px;background:linear-gradient(135deg,#d946ef,#a21caf);padding:0.7rem 1.25rem;font-family:'Manrope',sans-serif;font-size:0.78rem;font-weight:700;color:#fff;text-decoration:none;box-shadow:0 8px 20px rgba(217,70,239,0.3);">
        ...
        <nav style="flex:1;display:flex;flex-direction:column;gap:0.15rem;">
            ...
            <a href="#" class="sl"><span class="material-symbols-outlined" style="font-size:20px;">folder_open</span><span>Projects</span></a>
            <a href="#" class="sl"><span class="material-symbols-outlined" style="font-size:20px;">draw</span><span>Canvases</span></a>
            <a href="#" class="sl"><span class="material-symbols-outlined" style="font-size:20px;">photo_library</span><span>Assets</span></a>
            <a href="#" class="sl"><span class="material-symbols-outlined" style="font-size:20px;">auto_awesome</span><span>AI Generate</span></a>
            <a href="#" class="sl"><span class="material-symbols-outlined" style="font-size:20px;">dashboard_customize</span><span>Templates</span></a>
        </nav>
        @auth
        <div style="margin-top:auto;padding-top:1.25rem;border-top:1px solid rgba(67,70,86,0.2);">
            <div style="display:flex;align-items:center;gap:0.75rem;padding:0 0.5rem;">
                <div style="width:36px;height:36px;border-radius:9999px;background:#d946ef;display:flex;align-items:center;justify-content:center;font-size:0.8rem;font-weight:700;color:#fff;flex-shrink:0;">{{ strtoupper(substr(Auth::user()->name, 0, 1)) }}</div>
                <div style="min-width:0;">
                    ...
                    <div style="font-size:0.6rem;color:#8d90a2;text-transform:uppercase;letter-spacing:0.08em;">Designer</div>
                </div>
            </div>
        </div>
        @endauth
    ...
    <div style="position:fixed;bottom:1.5rem;right:1.5rem;display:flex;align-items:center;gap:0.5rem;padding:0.4rem 0.85rem;background:rgba(49,57,77,0.7);backdrop-filter:blur(16px);border-radius:9999px;border:1px solid rgba(67,70,86,0.2);z-index:50;">
        ...
        <span style="font-size:0.58rem;font-weight:700;color:rgba(218,226,253,0.5);text-transform:uppercase;letter-spacing:0.18em;">Dot.Design Online</span>
    </div>
    @stack('modals')
    @livewireScripts
</body>
