...
<head>
    ...
    <style>
        :root { --accent: #ec4899; --accent-rgb: 236,72,153; }
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .brand-icon { width:36px; height:36px; border-radius:10px; background:rgba(236,72,153,0.12); border:1px solid rgba(236,72,153,0.22); display:flex; align-items:center; justify-content:center; flex-shrink:0; }
        .brand-icon .material-symbols-rounded { font-size:18px; color:#ec4899; }
